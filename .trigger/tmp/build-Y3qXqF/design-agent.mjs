...
import {
  ...
  external_exports,
  task
} from "./chunk-IWKS2BQE.mjs";
import "./chunk-ZASOUCOI.mjs";
import {
  __commonJS,
  __name,
  __toESM,
...
var DownloadError = class extends (_b = AISDKError, _a = symbol, _b) {
  ...
  static isInstance(error3) {
    return AISDKError.hasMarker(error3, marker);
  }
};
...
function isAbortError(error3) {
  return (error3 instanceof Error || error3 instanceof DOMException) && (error3.name === "AbortError" || error3.name === "ResponseAborted" || // Next.js
...
function isBunNetworkError(error3) {
...
function handleFetchError({
  ...
  if (error3 instanceof TypeError && FETCH_FAILED_ERROR_MESSAGES.includes(error3.message.toLowerCase())) {
  ...
  if (isBunNetworkError(error3)) {
    return new APICallError({
      message: `Cannot connect to API: ${error3.message}`,
      cause: error3,
      url: url2,
      requestBodyValues,
      isRetryable: true
...
function visit(def2) {
  if (typeof def2 === "boolean") return def2;
  return addAdditionalPropertiesToJsonSchema(def2);
}
__name(visit, "visit");
...
var getDefaultOptions = /* @__PURE__ */ __name((options2) => typeof options2 === "string" ? {
  ...defaultOptions,
  name: options2
} : {
  ...defaultOptions,
...
function parseArrayDef(def2, refs) {
  ...
  if (((_a2 = def2.type) == null ? void 0 : _a2._def) && ((_c = (_b2 = def2.type) == null ? void 0 : _b2._def) == null ? void 0 : _c.typeName) !== ZodFirstPartyTypeKind.ZodAny) {
  ...
  if (def2.minLength) {
    res.minItems = def2.minLength.value;
  }
  if (def2.maxLength) {
    res.maxItems = def2.maxLength.value;
  }
  if (def2.exactLength) {
    res.minItems = def2.exactLength.value;
    res.maxItems = def2.exactLength.value;
  }
  return res;
}
__name(parseArrayDef, "parseArrayDef");
function parseBigintDef(def2) {
  const res = {
    type: "integer",
    format: "int64"
  };
...
function parseDateDef(def2, refs, overrideDateStrategy) {
  ...
  switch (strategy) {
    ...
    case "integer":
      return integerDateParser(def2);
  }
}
__name(parseDateDef, "parseDateDef");
var integerDateParser = /* @__PURE__ */ __name((def2) => {
  const res = {
    type: "integer",
    format: "unix-time"
  };
...
function parseRecordDef(def2, refs) {
  ...
  const schema = {
    type: "object",
    additionalProperties: (_a2 = parseDef(def2.valueType._def, {
      ...refs,
      currentPath: [...refs.currentPath, "additionalProperties"]
    })) != null ? _a2 : refs.allowedAdditionalProperties
  };
  if (((_b2 = def2.keyType) == null ? void 0 : _b2._def.typeName) === ZodFirstPartyTypeKind.ZodString && ((_c = def2.keyType._def.checks) == null ? void 0 : _c.length)) {
...
var asAnyOf = /* @__PURE__ */ __name((def2, refs) => {
  const anyOf = (def2.options instanceof Map ? Array.from(def2.options.values()) : def2.options).map(
    (x, i) => parseDef(x._def, {
      ...refs,
...
function parseSetDef(def2, refs) {
  ...
  if (def2.minSize) {
    schema.minItems = def2.minSize.value;
  }
  if (def2.maxSize) {
    schema.maxItems = def2.maxSize.value;
  }
  return schema;
}
...
var selectParser = /* @__PURE__ */ __name((def2, typeName, refs) => {
  switch (typeName) {
    ...
    case ZodFirstPartyTypeKind.ZodNumber:
      return parseNumberDef(def2);
    case ZodFirstPartyTypeKind.ZodObject:
      return parseObjectDef(def2, refs);
    case ZodFirstPartyTypeKind.ZodBigInt:
      return parseBigintDef(def2);
...
function parseDef(def2, refs, forceResolution = false) {
  ...
  if (jsonSchema2) {
    addMeta(def2, refs, jsonSchema2);
  }
  if (refs.postProcess) {
    const postProcessResult = refs.postProcess(jsonSchema2, def2, refs);
...
var addMeta = /* @__PURE__ */ __name((def2, refs, jsonSchema2) => {
  if (def2.description) {
    jsonSchema2.description = def2.description;
  }
  return jsonSchema2;
}, "addMeta");
var getRefs = /* @__PURE__ */ __name((options2) => {
  ...
  return {
    ...
    propertyPath: void 0,
    seen: new Map(
      Object.entries(_options.definitions).map(([name2, def2]) => [
        def2._def,
        {
          def: def2._def,
...
var zod3ToJsonSchema = /* @__PURE__ */ __name((schema, options2) => {
  var _a2;
  ...
  const name2 = typeof options2 === "string" ? options2 : (options2 == null ? void 0 : options2.nameStrategy) === "title" ? void 0 : options2 == null ? void 0 : options2.name;
...
function zod3Schema(zodSchema2, options2) {
  var _a2;
  const useReferences = (_a2 = options2 == null ? void 0 : options2.useReferences) != null ? _a2 : false;
  return jsonSchema(
...
async function safeValidateTypes({
  ...
  try {
    ...
    return {
      success: false,
      error: TypeValidationError.wrap({ value, cause: error3, context }),
      rawValue: value
    };
  }
}
...
async function parseJSON({
  ...
  try {
    ...
    throw new JSONParseError({ text, cause: error3 });
  }
}
...
async function safeParseJSON({
  ...
  try {
    ...
    return {
      success: false,
      error: JSONParseError.isInstance(error3) ? error3 : new JSONParseError({ text, cause: error3 }),
      rawValue: void 0
    };
  }
}
...
var postToApi = /* @__PURE__ */ __name(async ({
  ...
  try {
    ...
    throw handleFetchError({ error: error3, url: url2, requestBodyValues: body.values });
  }
}, "postToApi");
...
__name(convertGroqUsage, "convertGroqUsage");
...
var groqLanguageModelOptions = external_exports2.object({
  reasoningFormat: external_exports2.enum(["parsed", "raw", "hidden"]).optional(),
  /**
   * Specifies the reasoning effort level for model inference.
   * @see https://console.groq.com/docs/reasoning#reasoning-effort
   */
  reasoningEffort: external_exports2.enum(["none", "default", "low", "medium", "high"]).optional(),
  /**
   ...
   * @default 'on_demand'
   */
  serviceTier: external_exports2.enum(["on_demand", "performance", "flex", "auto"]).optional()
});
...
__name(isBrowserSearchSupportedModel, "isBrowserSearchSupportedModel");
function getSupportedModelsString() {
  return BROWSER_SEARCH_SUPPORTED_MODELS.join(", ");
}
__name(getSupportedModelsString, "getSupportedModelsString");
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    const structuredOutputs = (_a2 = groqOptions == null ? void 0 : groqOptions.structuredOutputs) != null ? _a2 : true;
    const strictJsonSchema = (_b2 = groqOptions == null ? void 0 : groqOptions.strictJsonSchema) != null ? _b2 : true;
    if (topK != null) {
  ...
  async doGenerate(options2) {
    ...
    return {
      ...
      finishReason: {
        ...
        raw: (_b2 = choice.finish_reason) != null ? _b2 : void 0
      },
  ...
  async doStream(options2) {
    const { args, warnings } = await this.getArgs({ ...options2, stream: true });
  ...
  async getArgs({
    ...
    if (groqOptions) {
      const transcriptionModelOptions = {
        language: (_a2 = groqOptions.language) != null ? _a2 : void 0,
        prompt: (_b2 = groqOptions.prompt) != null ? _b2 : void 0,
...
var groqTranscriptionResponseSchema = external_exports2.object({
  ...
  task: external_exports2.string().nullish(),
  language: external_exports2.string().nullish(),
...
var VERSION2 = true ? "3.0.39" : "0.0.0-test";
function createGroq(options2 = {}) {
  var _a2;
  const baseURL = (_a2 = withoutTrailingSlash(options2.baseURL)) != null ? _a2 : "https://api.groq.com/openai/v1";
...
function edit(regex, opt = "") {
  ...
  const obj = {
    replace: /* @__PURE__ */ __name((name2, val) => {
...
async function fetchPolyfill() {
  return typeof globalThis.fetch !== "undefined" ? globalThis.fetch : (await import("./lib-NCZJHF6Z.mjs")).default;
}
...
var designAgent = task({
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    ...
    const groq2 = createGroq({ apiKey: process.env.GROQ_API_KEY });
...
Extend or modify based on the request; only clear if explicitly asked.`;
      ...
      const result = await generateText({
        model: groq2("llama3-groq-70b-8192-tool-use-preview"),
